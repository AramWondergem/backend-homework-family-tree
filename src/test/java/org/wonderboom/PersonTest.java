...
class PersonTest {
    ...
    @Test
    void when_addParentsIsCalled_Expect_getMotherAndgetFatherReturnListWithMinimalOnePerson() {
        //Arrange
        Person child = new Person("Greet");
        Person mother1 = new Person("Linda");
        Person mother2 = new Person("Romy");
    ...
    @Test
    void when_addChildIsCalled_Expect_getChildrenReturnsListWithOneMorePerson() {
        //Arrange
        Person child = new Person("Greet");
        Person mother1 = new Person("Linda");
        // Act
    ...
    void when_SiblingIsAdded_Expect_PersonAddedIsSameAsSiblingReturned() {
        //Arrange
        Person sibling = new Person("Hans");
        Person person = new Person("Grietje");
        //Act
    ...
    void when_getGrandChildren_Expect_ListgrandChildrenContainAllPersonAddedToTheChilderenOfThePerson() {
        ...
        //Arrange
        Person grandMother = new Person("Greetje");
        Person daugther = new Person("Lies");
        Person daugther2 = new Person("Linda");
        Person grandChild1 = new Person("Storm");
        Person grandChild2 = new Person("Melody");
        Person grandChild3 = new Person("Hans");
        Person grandChild4 = new Person("Greetje junior");
